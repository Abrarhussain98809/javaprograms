...
public class Cart {
	...
	public Cart(Integer carId, int cartId, String userId, String brand, String model, double year, String color,
	...
	public String toString() {
		return "Cart [carId=" + carId + ", cartId=" + cartId + ", userId=" + userId + ", brand=" + brand + ", model="
